...
| W6 (Nov 16) | Monitoring Strategy & Supply Chain Security | TCS | The turbine control system is vendor-maintained balance-of-plant equipment with remote diagnostic access and vendor-delivered firmware, and RG 5.71 Rev. 1 brought BOP systems that could affect reactivity or cause an unplanned shutdown into 10 CFR 73.54 scope, so it is where supply chain trust and monitoring coverage have to be designed against each other under a scope that only recently applied. |
| W7 (Nov 30) | Incident Response in Nuclear Environments | RMS | Radiation monitoring readings drive emergency action level classification, so an integrity attack on RMS forces the response team to make 10 CFR 50.72 and 73.77 notification decisions on instrument data it cannot trust. |
...
**W2 PSI.** PSI is Physical Security Integration, a Security CDA. The Plant Architecture Diagram places it in the Site Ops L3 band, so cite Level 3 rather than a range. Its strongest theme affinity is W5 rather than W2. The insider threat half of Module 2 supports the W2 placement, but check PSI's W2 affinity rating on the Plant Architecture Diagram before committing. If it rates only Applicable rather than Strong, the cleanest fix is to swap PSI into W5 and drop the RPS revisit.
...
| 2026-09-08 | Corrected the W7 RMS justification from 73.71 to 73.77 | 10 CFR 73.71 and Appendix G cover physical security event reporting. Cyber security event notifications are governed by 10 CFR 73.77, confirmed in RG 5.71 Rev. 1 Section C.3.3.2.6. The original citation contradicted my own reasoning chain test. |
| 2026-09-08 | Added the RG 5.71 Rev. 1 balance-of-plant scope to the W6 TCS justification, and corrected the PSI level note | RG 5.71 Rev. 1 added BOP scope following SRM-COMWCO-10-0001, which gives TCS a cited regulatory hook. The Plant Architecture Diagram places PSI at Level 3, not a 2-3 range. |
