...
| W3 (Oct 5) | Protocol Security & Access Control | EDGC | EDGC is my instructor-assigned W3 system. Its start signals, permissives, and status reporting travel over control network protocols, and its local and remote control paths raise direct access-control questions about who or what is allowed to command backup power equipment. |
...
| W6 (Nov 16) | Monitoring Strategy & Supply Chain Security | DCS | DCS runs on vendor-supported controllers and engineering workstations with firmware and software dependencies that arrive through the vendor, making it useful for studying supply chain trust. Its continuous process monitoring and configuration activity also give me a large stream of normal behavior against which monitoring strategy can be designed. |
...
**W3 EDGC.** EDGC stands alone in W3 following the instructor's correction of my W3 assignment. This gives me a focused protocol and access-control analysis on backup power equipment without adding a second system.

**W6 TCS and DCS.** W6 now uses two systems. TCS gives me a supply chain case involving specialized control hardware, software, and vendor support. DCS adds a second supply chain and monitoring case through its vendor-supported controllers, engineering workstations, and firmware and software dependencies, and its process monitoring and configuration activity give me material for monitoring strategy.
...
**Suggested pairings not used.** The course materials suggest some natural system pairings, including DCS with PPC and RPS with EDGC. This plan separates them because PPC is used as an adversary target in W2, EDGC is my instructor-assigned W3 system, RPS is the W4 digital I&C system, and DCS is placed in W6, where its vendor-supported controllers, engineering workstations, and configuration activity fit Monitoring Strategy and Supply Chain Security.
...
The thread is data: where it is produced, how it moves, who can alter it, and what decisions are made from it. W1 starts with OT-SIEM because monitoring brings information from several plant systems into one place. W2 moves into PPC and PSI to examine operational records and physical security information from an adversary perspective, while W3 moves into EDGC to study the industrial protocols and access boundaries that control backup power equipment. W4 moves into the safety-critical RPS environment, and W5 shifts to SFPCM to examine the connection between cyber risk, physical protection, safety, and regulation. W6 combines TCS and DCS to examine supply chain trust and monitoring across vendor-supported control equipment, while W7 and W8 move into incident response and emerging technology. W9 returns to ICT-SIEM so the sequence ends by comparing enterprise monitoring with the OT monitoring system studied in W1.

My comfort zone is strongest around data, monitoring, and integrity, so the sequence becomes harder as it moves closer to physical plant processes. RPS and SFPCM will require me to understand how cyber events can affect safety functions and how nuclear regulatory requirements change the analysis. EDGC now arrives earlier, in W3, so I will have to think about equipment availability and how to separate normal degradation from possible malicious activity sooner than the original sequence assumed. W8 will be challenging because side-channel analysis requires more understanding of hardware and physical behavior than I currently have. W6 and W7 should connect more closely to my existing background because monitoring, supply chain data, incident evidence, and making decisions from information are concepts I already understand.
...
| 2026-09-24 | Instructor corrected the W3 assignment: restored EDGC to W3 and moved DCS to W6 alongside TCS | My assigned W3 system is EDGC. The 2026-09-08 entry above recorded moving EDGC away from W3, and a later deduplication pass misread that line as evidence that EDGC belonged in W6. DCS fits W6 Monitoring Strategy and Supply Chain Security through its vendor-supported controllers, engineering workstations, firmware and software dependencies, process monitoring, and configuration activity, and W6 allows two systems. RPS stays in W4 as the stronger digital I&C and safety-critical system. |