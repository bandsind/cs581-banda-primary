...
<!-- 
Write this last. One paragraph, professional tone, as if a hiring manager at INL,
a DOE contractor, or an NRC-regulated utility will read it.
What does this portfolio demonstrate about your capabilities?
Be specific — name systems, frameworks, and techniques.
-->
...
**Where it fell short:**
<!-- Specific failures, errors it made, things you had to correct. -->

**How my prompting evolved:**
<!-- Compare your Session 1 prompts to your Session 5 prompts. What changed? -->

---

## Most Significant Session Log Insight

<!-- 
One thing you learned from a session log that isn't captured in the artifact itself.
Often this is a failure, a correction, or a moment where the AI was confidently wrong.
-->
